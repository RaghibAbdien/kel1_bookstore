        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-lg-12">
                        <h5 class="card-header-text">Form Edit Stock</h5>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputProductname"
                                        ...
                                        value="{{ $stocks->product->product_name }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="exampleWarehouse" name="warehouse_id">
                                        @foreach ($warehouses as $warehouse)
                                            <option value="{{ $warehouse->id }}"
                                                {{ $warehouse->id == $stocks->warehouse_id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputRestockThreshodl"
                                        ...
                                        placeholder="Enter RestockThreshodl" value="{{ $stocks->restock_threshold }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
